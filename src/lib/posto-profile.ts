...
export type UpdatePostoSettingsInput = {
  ...
  avisoWhatsapp3: string
  avisoWhatsapp4: string
  avisoWhatsapp5: string
  photoFile?: File | null
...
const PROFILE_SELECT =
  'id, nome, cnpj, telefone, email, endereco, cep, logradouro, numero, complemento, bairro, cidade, uf, foto_storage_path, latitude, longitude, public_slug, aviso_whatsapp_1, aviso_whatsapp_2, aviso_whatsapp_3, aviso_whatsapp_4, aviso_whatsapp_5'
